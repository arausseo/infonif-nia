// forked from design-sync lib/source-kit.mjs — GENERIC_DIR solo tiene nombres en inglés
...
// Añadidos los equivalentes en español: este repo nombra en español (CLAUDE.md),
// y 'componentes' agrupa tan poco como 'components'. Sin esto, seis de los diez
// componentes caían en un cajón llamado «componentes» y el category del
// frontmatter no llegaba a aplicarse nunca.
const GENERIC_DIR = new Set([
  'components', 'component', 'src', 'lib', 'ui', 'packages', 'react',
  'componentes', 'componente', 'fuente', 'biblioteca',
]);
